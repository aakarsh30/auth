...
<hr/>
    <div className="fd">
    <img src="/Lopard/iv.png" className="jjj" />
    <div className="texx">Industries & Manufacturing</div>
    </div>
        <div className="fd">
    <img src="/Lopard/v.png" className="jjj" />
    <div className="texx">Automobile & Transportation</div>
    </div>
        <div className="fd">
    <img src="/Lopard/vi.png" className="jjj" />
    <div className="texx">Food &<br />Agriculture</div>
    </div>
        <div className="fd">
    <img src="/Lopard/vii.png" className="jjj" />
    <div className="texx">Health & Humanbody</div>
    </div>
        <div className="fd">
    <img src="/Lopard/viii.png" className="jjj" />
